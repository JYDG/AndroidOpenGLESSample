...
extern "C" {
    JNIEXPORT void JNICALL Java_com_github_mugku_androidopenglessampleproject_ndk_GLES3JNILib_init(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_com_github_mugku_androidopenglessampleproject_ndk_GLES3JNILib_resize(JNIEnv* env, jobject obj, jint width, jint height);
...
Java_com_github_mugku_androidopenglessampleproject_ndk_GLES3JNILib_init(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
JNIEXPORT void JNICALL
Java_com_github_mugku_androidopenglessampleproject_ndk_GLES3JNILib_resize(JNIEnv* env, jobject obj, jint width, jint height) {
    if (g_renderer) {
